...
//        schedule.addDrugToSchedule(patient2, acyclovir, LocalDateTime.of(2024, 9, 29, 10, 0));
        Disease disease1 = new Disease(1,44.0, "2024 год 12 месяц 10 день", new ArrayList<>());
        Disease disease2 = new Disease(2,30.0, "2024 год 12 месяц 08 день", new ArrayList<>());
...
//        schedule.showSchedule();
        System.out.println(disease1.duration());
        System.out.println(disease2.duration());
     }
}